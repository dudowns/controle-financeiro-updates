...
class _InvestimentosTabsScreenState extends State<InvestimentosTabsScreen>
  ...
  // 🔥 NOVA FUNÇÃO PARA CALCULAR EVOLUÇÃO MENSAL REAL
  ...
  // 🔥 FUNÇÃO AUXILIAR PARA CONVERTER MÊS
            ...
            child: Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      _formatarValor(item['valor_final'] ?? item['valor']),
                      style: const TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 16,
                        color: Colors.teal,
                    ...
                    if (item['rendimento_liquido'] != null &&
                        item['rendimento_liquido'] > 0)
                      Text(
                        '+${_formatarValor(item['rendimento_liquido'])} '
                        '(${((item['rendimento_liquido'] / item['valor']) * 100).toStringAsFixed(2)}%)',
                        style: TextStyle(
                          fontSize: 11,
                    ...
                    // 🔥 NOVO: Mostra o rendimento diário aproximado
    ...
    return Column(
      children: [
          ...
          children: [
            ...
            Container(
                ...
                decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(20)),
                child: Text('${investimentos.length + rendaFixa.length} ativos',
        ...
        Row(
          crossAxisAlignment: CrossAxisAlignment.end,
          children: [
            Text(_formatarValor(totalAtual),
                style: const TextStyle(
                    fontSize: 28,
                    fontWeight: FontWeight.bold,
                    color: Colors.white)),
        ...
        Row(
          children: [
            ...
            Expanded(
                child: _buildMetricCard(
                    'Rendimento',
                    _formatarValor(totalAtual - totalInvestido),
                    Icons.trending_up,
            ...
            const SizedBox(width: 12),
            Expanded(
                child: _buildMetricCard('Dividendos',
                    _formatarValor(dividendosRecebidos), Icons.monetization_on,
                    cor: Colors.green)),
          ],
        ),
      ],
  ...
  Widget _buildMetricCard(String label, String valor, IconData icone,
      {Color? cor}) {
    return Container(
      padding: const EdgeInsets.all(8),
      decoration: BoxDecoration(
                ...
                Row(
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      children: [
                        Text(_formatarValor(precoAtual),
                            style: const TextStyle(
                                fontWeight: FontWeight.bold, fontSize: 16)),
                        const SizedBox(height: 4),
                        Container(
            ...
            Row(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      color:
                          (variacaoPercentual >= 0 ? Colors.green : Colors.red)
                              .withOpacity(0.2),
                      borderRadius: BorderRadius.circular(20)),
                  child: Row(
                    children: [
              ...
              children: [
                Expanded(
                  ...
                  Text('Ganho Capital',
                      style: TextStyle(fontSize: 12, color: Colors.grey[600])),
                  const SizedBox(height: 4),
                  Text(_formatarValor(ganhoCapital),
                      style: TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                ...
                Expanded(
                  ...
                  Text('Dividendos',
                      style: TextStyle(fontSize: 12, color: Colors.grey[600])),
                  const SizedBox(height: 4),
                  Text(_formatarValor(dividendosRecebidos),
                      style: const TextStyle(
                          fontSize: 18,
                          fontWeight: FontWeight.bold,
                          color: Colors.green))
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(_formatarValor(ganhoCapital + dividendosRecebidos),
                      style: const TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 18,
              ...
              child: Column(
                ...
                children: [
                  Text('PROVENTOS (12M)',
                      style: TextStyle(fontSize: 12, color: Colors.grey[600])),
                  const SizedBox(height: 8),
                  Text(_formatarValor(proventos12Meses),
                      style: const TextStyle(
                          fontSize: 28,
                          fontWeight: FontWeight.bold,
                          color: Color(0xFF6A1B9A))),
  ...
  // 🔥 GRÁFICO DE BARRAS MENSAIS COM DADOS REAIS
        ...
        child: Column(
          ...
          children: [
              ...
              child: BarChart(
                BarChartData(
                  ...
                  borderData: FlBorderData(
                    show: false, // 🔥 REMOVE A BORDA!
                  ),
                  gridData: const FlGridData(
                    show: false, // 🔥 REMOVE AS LINHAS PONTILHADAS!
                  ),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                _buildLegendaCor('Patrimônio', const Color(0xFF6A1B9A)),
  ...
  Future<void> _abrirDialogAdicionar() async {
    ...
    void calcularTotal() {
      try {
        ...
        totalController.text =
            'R\$ ${(quantidade * preco).toStringAsFixed(2).replaceAll('.', ',')}';
      } catch (e) {
    ...
    Future<void> selecionarData(
      ...
      if (data != null) setDialogState(() => dataSelecionada = data);
    }
            ...
            content: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  InkWell(
                    onTap: () => selecionarData(context, setDialogState),
                    child: Container(
                      padding: const EdgeInsets.symmetric(
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  await db.insertInvestimento({
                    ...
                    'preco_medio': preco,
                    'preco_atual': preco,
                    'data_compra': dataSelecionada.toIso8601String(),
                  });
