...
class _AdicionarDepositoScreenState extends State<AdicionarDepositoScreen> {
  ...
  // ❌ MÉTODO REMOVIDO - não estava sendo usado!
  // double _calcularTotalAposDeposito() { ... }
  ...
  Future<void> _salvarDeposito() async {
    try {
      ...
      // TODO: Criar tabela de depósitos no DBHelper
      // Por enquanto, apenas atualiza o valor atual da meta
