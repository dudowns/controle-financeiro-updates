...
class _DetalhesMetaScreenState extends State<DetalhesMetaScreen> {
  ...
  void initState() {
    super.initState();
    metaAtual = Map.from(widget.meta); // Cópia para poder atualizar
    _carregarDepositos();
  }

  Future<void> _carregarDepositos() async {
    // TODO: Implementar busca de depósitos quando criar a tabela
    setState(() {});
  }
                              ...
                              Row(
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                        _formatarValor((deposito['valor'] ?? 0)
                                            .toDouble()),
                                        style: const TextStyle(
                                          fontWeight: FontWeight.bold,
                                        ),
